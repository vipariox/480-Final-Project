...
The output for the Virginia Naive Bayes model can be found [here](https://github.com/vipariox/480-Final-Project/blob/master/VA%20Naive%20Bayes%20Output.xlsx).
<img src="VA Naive Bayes prediction output.PNG" width="900">



#### Naive Bayes Output - New York
The output for the New York Naive Bayes model can be found [here](https://github.com/vipariox/480-Final-Project/blob/master/NY%20Naive%20Bayes%20Output.xlsx).
